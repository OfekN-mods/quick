...
public interface ISlotKey {
    Codec<ISlotKey> CODEC = SlotType.CODEC.dispatch(ISlotKey::type, SlotType::codec);
    StreamCodec<RegistryFriendlyByteBuf, ISlotKey> STREAM_CODEC = SlotType.STREAM_CODEC
